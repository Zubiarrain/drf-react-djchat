...
from .validators import validate_icon_image_size, validate_image_file_extention
...
class Category(models.Model):
    ...
    @receiver(pre_delete, sender="server.Category")
...
class Server(models.Model):
    ...
    @receiver(pre_delete, sender="server.Server")
